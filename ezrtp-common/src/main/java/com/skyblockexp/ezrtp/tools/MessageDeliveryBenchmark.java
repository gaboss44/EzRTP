 ...
 * Run with: `java -cp ezrtp-common/target/ezrtp-common-1.6.2.jar:ezrtp-bukkit/target/ezrtp-bukkit-1.6.2.jar:<path-to-deps> com.skyblockexp.ezrtp.tools.MessageDeliveryBenchmark`
 */
